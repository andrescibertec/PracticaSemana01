...
public class ClienteController {
	...
	@PostMapping
	public ResponseEntity<?>  registroCliente(@RequestBody Cliente obj){
		List<String> lstSalida = new ArrayList<String>();
		
		obj.setFechaRegistro(new Date());
		
		Cliente objSalida = service.RegistroCliente(obj);
		if (objSalida == null) {
			lstSalida.add("Error en el registro");
		}else {
			lstSalida.add("se registra el cliente con el id : " + objSalida.getIdCliente());
		}
